...
def index():
  ...
  print(r.url)
  r1 = requests.post("https://giridev1c5232886trial.hanatrial.ondemand.com/ChatBot_DEV/Read.xsjs",json = postdata)
  print(r1.text)
  ...
  return jsonify(
    ...
    replies=[{
      'type': 'text',
	  'content': 'The Salary of %s is %d.' % (crypto_name_test, r.json()[0]['SAL'])
    }]
  )
